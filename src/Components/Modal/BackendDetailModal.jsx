...
export default function BackendDetailModal({
  closeModal,
  isOpen,
  openModal,
  title,
  ...
  const [BckFirstName, setBckFirstName] = useState("");
  const [BckLastName, setBckLastName] = useState("");
  const [BckEmail, setBckEmail] = useState("");
  const [BckSkills, setBckSkills] = useState([]);

  function handleSubmit(event) {
    event.preventDefault();
    closeModal();
    localStorage.setItem("BckFirstName", BckFirstName);
    localStorage.setItem("BckLastName", BckLastName);
    localStorage.setItem("BckEmail", BckEmail);
    const MySkills = BckSkills.split(",");
    setBckSkills(MySkills);
    localStorage.setItem("BckSkills", BckSkills);
  }
  return (
    <>
                  ...
                  >
                    <div className="w-full bg-lightGreen rounded-md p-2 flex flex-col">
                      ...
                      <input
                        ...
                        id="firstname"
                        onChange={(e) => {
                          setBckFirstName(e.target.value);
                        }}
                        value={BckFirstName}
                      />{" "}
                    </div>
                    ...
                    <div className="bg-lightGreen">
                      ...
                      <input
                        ...
                        name="fav_language"
                        onChange={(e) => {
                          setBckSkills(e.target.value);
                        }}
                        value={[BckSkills.concat(["HTML,"])]}
                      />
                      ...
                      <input
                        ...
                        value={[BckSkills.concat(["Javascript,"])]}
                      />
