...
export default function FrontendDetailModal({
  closeModal,
  isOpen,
  openModal,
  title,
  ...
  const [FrontFirstName, setFrontFirstName] = useState("");
  const [FrontLastName, setFrontLastName] = useState("");
  ...
  function handleSubmit(event) {
    ...
    closeModal();
    localStorage.setItem("FrontFirstName", FrontFirstName);
    localStorage.setItem("FrontLastName", FrontLastName);
    localStorage.setItem("FrontEmail", FrontEmail);
    const MySkills = FrontSkills.split(",");
    setFrontSkills(MySkills);
    localStorage.setItem("FrontSkills", FrontSkills);
  }
  return (
    <>
                  ...
                  >
                    <div className="w-full bg-lightGreen rounded-md p-2 flex flex-col">
                      ...
                      <input
                        ...
                        id="firstname"
                        onChange={(e) => {
                          setFrontFirstName(e.target.value);
                        }}
                        value={FrontFirstName}
                      />{" "}
                    </div>
                    <div className="w-full bg-lightGreen rounded-md p-2 flex flex-col">
                      ...
                      <input
                        ...
                        id="lastname"
                        onChange={(e) => {
                          setFrontLastName(e.target.value);
                        }}
                        value={FrontLastName}
                      />{" "}
                    </div>
                    ...
                    <div className="bg-lightGreen">
                      ...
                      <input
                        ...
                        name="fav_language"
                        onChange={(e) => {
                          setFrontSkills(e.target.value);
                        }}
                        value={[FrontSkills.concat(["HTML,"])]}
                      />
                      ...
                      <input
                        ...
                        value={[FrontSkills.concat(["Javascript,"])]}
                      />
