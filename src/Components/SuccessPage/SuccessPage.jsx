...
const SuccessPage = () => {
  return (
    <div className="bg-blue-gradient h-[100vh] w-full">
      <div className="top-[50%] left-[50%] absolute transform -translate-x-[50%] -translate-y-[50%] text-darkBlue text-[14px] bg-white p-6 rounded-lg flex flex-col items-center">
        <article>
          <h1 className="font-bold text-[30px]">Dear Valued Customer,</h1>
          <p>
